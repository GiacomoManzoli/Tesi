...
\defcounter {refsection}{0}\relax 
\contentsline {lstlisting}{\numberline {5.1}JSON Schema di GET /g/{galleryCode}/nodi/{args}}{32}{lstlisting.5.1}
\defcounter {refsection}{0}\relax 
\contentsline {lstlisting}{\numberline {5.2}JSON Schema di GET /g/{galleryCode}/contents/{args}}{33}{lstlisting.5.2}
\defcounter {refsection}{0}\relax 
